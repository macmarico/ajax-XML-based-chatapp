...
<div class="adj" style=" height: 53px"> <a style= "color : white ;" href=" home.php">back</a>
...
<?php
     $xml =simplexml_load_file("../users/$recivernm/posts/postlist.xml") or die("Error: Cannot create object"); // what user freind has sent
     $xmlArray = array();
  ...
  <div class="msgbar mbc">
    ...
    <div class="msgtab">
     ...
     <div class="row">
        ...
        <div class="b2 unadj" style="font-size:13px;"  >
             <?php
echo $recivernm;?>
 </div> 
 <div class="b2 unadj" style="font-size:13px;color:#f43e2e"  ><?php echo $tag ; ?>
    ...
    <?php
     ...
     if(!empty($postpic)){
   ?>
   <img src="../users/<?php echo $recivernm ;?>/posts/files/<?php echo $statusID ;?>/storage/post/<?php echo $postpic ;?>" alt="Trulli" width="320" height="auto" style="border-radius: 15px;>
    <?php }?>
    
    
    <div class="mytab " style="font-size:16px">
     ...
     echo  $message->topic ;
      ...
      ?></strong><br><br><?php }
               ...
               $pattern = '@(http(s)?://)?(([a-zA-Z])([-\w]+\.)+([^\s\.]+[^\s]*)+[^,.\s])@';
                $output = preg_replace($pattern, ' <a href="http$2://$3">   <sup style="font-size:12px ; color:#538b01" class="fa">&nbsp  link &#xf112 &nbsp </sup> </a>', $message->post);     
...
<div class="set">
  ...
  <div style="font-size: 15px; color: #999">Comments</div>
</div>
...
<div class="set">
  ...
  <div class="msgbar" style = " position: fixed; width: 100%; bottom: 0px; ">
    <div class="msgtab">
      <form method="get" action="parts/postcore.php" id="formpost" name="formpost" class="formpost">
      <div class="msgcomp">
        <input style="width:80%; border-radius: 25px;" type="text" name="message"  placeholder="Type Comment" class="width ProximaNovaRegular inpdes msgbut clubinput" autocomplete="off" data-emojiable="true" data-emoji-input="unicode" required />
        ...
        <input type="hidden" name="postpic" value="<?php echo $postpic; ?>">
...
function loadDoc() {
  ...
  xhttp.open("GET", "../users/<?php echo $recivernm;?>/posts/files/<?php echo $statusID;?>/<?php echo $statusID ;?>.xml", false);
