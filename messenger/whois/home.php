...
<div id="myModal" class="modal">
 ...
 <div class="feedSection" id="IDfeedSection"></div>
...
<div style="position:fixed; bottom: 20px; right:20px;" >
    <button style="background-color:transparent; border: none;" id="myBtn">
        <svg width="4.7em" height="4.7em" viewBox="0 0 16 16" class="bi bi-plus-circle-fill" fill="#f43e2e" xmlns="http://www.w3.org/2000/svg">
