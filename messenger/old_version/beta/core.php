...
if(empty($chat->message))
{
          ...
          <div class="messeging">
          <p id="hmsg" style="font-size:10px;font-style:italic;color:red">Image may contain nudity are you sure to open click on image </p>
            <img src="<?php echo $chat->link ; ?>" class="sharedimg" id="img"  > 
            <div><form method="post" action="block.php" class="emojiform">
      <input type="hidden" name="emojiname" value="<?php echo $chat->link ; ?>">
      <input type="hidden" name="recivernm" value="<?php echo $recivernm; ?>">
      <input type="submit" name="recivernm" class="dangbut" value="Report Pic">
      </form>
