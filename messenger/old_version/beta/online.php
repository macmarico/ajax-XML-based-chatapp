...
<div class="memlayt">
      ...
      <?php
           ...
           $sqlstatus = "SELECT status FROM sessions WHERE username= '".$row["username"]."'";
                ...
                <input type="hidden" name="motive" value="<?php echo $check["status"]; ?>" class="dmotive">
                <button type="submit" class="dmotive ProximaNovaRegular  "> <?php echo $check["status"]; ?><br><p style="font-size:13px;color:#ff6c00"  class=" ProximaNovaRegular"> DISCUSS </p></button>
                </form>
